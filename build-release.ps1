...
$unsignedApk = Join-Path $repoRoot 'build\outputs\apk\release\mespeak-release-unsigned.apk'
$signedApk = Join-Path $repoRoot "build\outputs\apk\mespeak-$versionName-android64.apk"
